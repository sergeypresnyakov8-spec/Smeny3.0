...
export const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbxB8uL2JBPgk_y6V4GqIBePeAAklxJXM6A7uv5ia6VUFBaNMl39MmD_QOaGcvGURY2Mew/exec";
...
export const NAMES = ["Администратор", "Сотрудник 1", "Сотрудник 2"];
...
export const Icons = {
  ...
  Sun: ({ size = 18, className = "" }: { size?: number, className?: string }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className={className}>
      <circle cx="12" cy="12" r="4" />
      <path d="M12 2v2m0 16v2M4.93 4.93l1.41 1.41m11.32 11.32l1.41 1.41M2 12h2m16 0h2" />
    </svg>
  ),
  Moon: ({ size = 16, className = "" }: { size?: number, className?: string }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className={className}>
